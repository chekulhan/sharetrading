...
selected_share = st.selectbox(
    ...
    ['^HSI', 'AGL.AX',  'ANA.MC', 'ANE.MC', 'BBVA.MC', 'CLNX.MC',  'CRYP.AX', 'CSC.AX', 'CSL.AX', 'FLC.AX', 'MEL.MC', 'MQAE.AX', 'NUF.AX', 'OHLA.MC', 'OFX.AX', 'PCX.AX', 'PE1.AX', 'PEN.AX', 'PPT.AX', 'RBTZ.AX', 'REP.MC', 'RIO.AX', 'SAN.MC', 'SYR.AX', 'WAR.AX', 'WMI.AX', 'WWI.AX', 'XCO2.AX'])
